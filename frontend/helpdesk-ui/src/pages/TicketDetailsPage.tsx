...
export default function TicketDetailsPage({
    ...
    return (
        <Container maxWidth="lg" sx={{ py: 4 }}>
            ...
            <Paper elevation={10} sx={{ p: 3, border: "1px solid", borderColor: "grey.200", borderRadius: 2 }}>
                {loading ? (
                            ...
                            <Paper variant="outlined" sx={{ p: 2, borderRadius: 2, borderColor: "grey.200" }}>
                                ...
                                <Stack spacing={1}>
                                    {allowedNextStatuses.map((s) => {
                                        ...
                                        const label = s === 1 ? "Move to In Progress" : s === 0 ? "Reopen Ticket" : "Close Ticket";
